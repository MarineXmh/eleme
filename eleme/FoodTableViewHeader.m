...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _seperateLineView = [[UIView alloc] initWithFrame:CGRectMake(0, 30 - 1, foodTableViewWidth, 1)];
        ...
        UIView *seperateLineOnTop = [[UIView alloc] initWithFrame:CGRectMake(0, 0, foodTableViewWidth, 1)];
